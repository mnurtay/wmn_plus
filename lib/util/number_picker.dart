...
class NumberPicker extends StatelessWidget {
  ...
  Widget _integerListView(ThemeData themeData) {
    TextStyle defaultStyle = TextStyle(color: Colors.black.withOpacity(0.7), fontSize: 16);
    TextStyle selectedStyle = TextStyle(color: themeData.accentColor, fontSize: 30, fontWeight: FontWeight.bold);
