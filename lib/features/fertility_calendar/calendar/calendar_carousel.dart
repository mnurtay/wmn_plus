...
class CalendarFertilityCarousel<T extends EventInterface> extends StatefulWidget {
  ...
  CalendarFertilityCarousel({
    ...
    this.selectedDayBorderColor = const Color(0xffD748DA),
    this.selectedDayButtonColor = const Color(0xffD748DA),
    ...
    this.inactiveWeekendTextStyle = const TextStyle(color: Colors.black),
...
class _CalendarState<T extends EventInterface>
    extends State<CalendarFertilityCarousel<T>> {
  ...
  @override
  void didUpdateWidget(CalendarFertilityCarousel<T> oldWidget) {
