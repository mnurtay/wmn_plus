...
import 'package:wmn_plus/features/ecommerce/screens/review_detail.dart';
...
import 'package:wmn_plus/features/ecommerce/widgets/todays_deals_card.dart';
          ...
          child: Column(
            children: <Widget>[
              ...
              discount
                  ...
                  : Container(),
              buildPriceRow('Цена ', selectedProduct.displayPrice + " KZT",
                  strike: discount,
                  originalPrice:
        ...
        return Padding(
          ...
          child: Container(
            ...
            child: FlatButton(
              ...
              child: Text(
                selectedProduct.isOrderable ? 'Купить сейчас' : 'OUT OF STOCK',
                style: TextStyle(
                    color: selectedProduct.isOrderable
                        ? Colors.deepOrange
                        : Colors.grey),
