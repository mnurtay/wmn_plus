...
import 'package:wmn_plus/features/ecommerce/screens/brandslisting.dart';
import 'package:wmn_plus/features/ecommerce/screens/categorylisting.dart';
            ...
            Container(
                ...
                child: ClipRRect(
                  child: Image.network(categories[index].image == null
                      ? ''
                      :"http://194.146.43.98:4000/image?uri=" + categories[index].image),
